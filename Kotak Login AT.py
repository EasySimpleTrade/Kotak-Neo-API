...
# Input (Change access token,mobile number,password with yours)
access_token = 'ey....' #Change access token
mobile_number = '+919876543210' #Change your mobile number with +91
pass_word = 'acc_pass' #Change your Password
login_file = r'C:\API\KotakLogin1.txt'#Change File path as per your PC
